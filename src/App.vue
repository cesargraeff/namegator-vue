              ...
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <div class="btn btn-info" v-on:click="addPrefix(prefix)"><span class="fa fa-plus"></span></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <div class="btn btn-info" v-on:click="addSufix(sufix)"><span class="fa fa-plus"></span></div>
                  </div>
                </div>
              </div>
            </div>
